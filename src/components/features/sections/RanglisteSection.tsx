...
const RanglisteSection: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-16 md:py-24 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-7 lg:gap-x-16 lg:gap-y-4 items-center text-center lg:text-left">
          ...
          >
            ...
            >
              Wer führt die ewige Rangliste an? Strichdifferenz, Siegquoten
              und Partner-Bilanzen — alle wichtigen Statistiken deiner Gruppe auf einen Blick.
            </p>
          </motion.div>
        </div>
      </div>
...
export default RanglisteSection;
