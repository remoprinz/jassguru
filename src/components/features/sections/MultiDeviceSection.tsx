    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 py-16 md:py-24 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-7 lg:gap-x-16 lg:gap-y-4 items-center text-center lg:text-left">
          ...
          {/* Phone */}
          <motion.div
            className="flex justify-center lg:col-start-1 lg:row-start-1 lg:row-span-2"
          ...
          >
            <LandingPhoneFrame>
              <Image
                src="/assets/screenshots/laufendem_jass_beitreten.webp"
                alt="Laufendem Jass beitreten — Multi-Device"
                fill
          ...
          >
            ...
            >
              Jeder am Tisch kann mitlesen und mitschreiben.
              Tritt einem laufenden Jass bei und der Spielstand synchronisiert sich
