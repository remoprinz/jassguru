...
const HeroSection: React.FC<HeroSectionProps> = ({ onInstall, onLogin }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute z-20 left-0 right-0 flex flex-col items-center gap-5 sm:gap-6 md:gap-7 lg:gap-8 px-4 pointer-events-none [&_.hero-cta-stack]:pointer-events-auto"
