...
import {calculateStricheCounts as calculateStricheData} from "../../game/scoreCalculations";
...
const StrichBox = styled("div")<{ customStyle: React.CSSProperties; isDisabled: boolean }>(({ customStyle, isDisabled }) => ({
  position: "absolute",
  width: "100%",
  display: "flex",
  alignItems: "center",
...
const StrichContainer: React.FC<StrichContainerProps> = ({
  ...
  const { striche, restZahl } = calculateStricheData(score);
  const visualStriche = { stricheCounts: striche, restZahl };
