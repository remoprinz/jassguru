          ...
          <li key={player.id}>
            ...
            >
              ...
              <Avatar className="h-10 w-10 flex-shrink-0">
                {/* TODO: player.photoURL hinzufügen, falls vorhanden */}
                <AvatarImage src={player.photoURL} alt={player.nickname} />
                <AvatarFallback
                  className={cn("text-gray-300 text-sm font-semibold",
                    isPlaceholder ? 'bg-yellow-700' : 'bg-gray-600'
                  )}
                >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate flex items-center gap-1.5">
                  ...
                  <span>{player.nickname || "Unbekannter Spieler"}</span>
                </p>
                {isPlaceholder && (
