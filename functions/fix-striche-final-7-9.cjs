...
async function fixStricheFinal79() {
    try {
        ...
        // Spiel 4: Claudia/Frank 1 Berg + 1 Sieg + 2 Matsch = 4 Striche
        ...
        console.log('✅ Spiel 4 korrigiert: Claudia/Frank 1 Berg + 1 Sieg + 2 Matsch = 4 Striche');
        ...
        console.log('- Spiel 4: 1 Berg + 1 Sieg (2) + 2 Matsch = 4 Striche');
