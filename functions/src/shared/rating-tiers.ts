...
export const RATING_TIERS: RatingTier[] = [
  ...
  { minRating: 105, name: "Bronzejasser", emoji: "🥉" },
  { minRating: 100, name: "Jassstudent (START)", emoji: "👨‍🎓" },
  ...
  { minRating: 65,  name: "Chlaus", emoji: "🎅" },
  { minRating: 60,  name: "Chäs", emoji: "🧀" },
  { minRating: 55,  name: "Ente", emoji: "🦆" },
  { minRating: 50,  name: "Gurke", emoji: "🥒" },
];

// Default Tier für Ratings unter 50
